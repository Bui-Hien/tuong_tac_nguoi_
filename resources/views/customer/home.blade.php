...
<header>
    ...
    <ul class=" header-middle  nav nav-pills nav-fill d-flex justify-content-between py-2 ">
        ...
        <li class="nav-item  ">
            <a href="{{route('booking')}}" class="btn w-30 btn-lg   " style="background-color:#90FF5B; "><h3
                    class=" text-center mb-0">Đặt Lịch</h3></a>
        </li>
    </ul>
</header>
    ...
    <div class="row">
        ...
        <div class="col-md-3" style="background-color: #FFCCCC">
            <div class="text-left p-3">
                ...
                <p>Được thành lập tại Việt Nam sau khi nhận thấy dịch vụ chăm sóc thú cưng ở Việt Nam không đáp ứng được
                    nhu cầu của chủ.</p>
                <p>Phòng khám thú y PetHaven sẵn sàng phục vụ 24/7. Chăm sóc các chú chó mèo của bạn cả ngày lẫn đêm,
                    hướng dẫn các chế độ chăm sóc thú cưng một cách tốt nhất.</p>
                <p>PetHaven có đội ngũ y bác sỹ hàng đầu Việt Nam trong lĩnh vực thú y và các chuyên gia tận tâm hết
                    mình vì sức khoẻ của thú cưng Việt.</p>
            </div>
        </div>
    </div>
</div>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"
        integrity="sha384-QwtQTHkWWmiYMtkePo6oJ4fGc7IB1YUbGZcmNtsD1S1anEHIxU7lR7QoTOmno4lT"
