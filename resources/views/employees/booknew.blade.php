                ...
                <ul class="nav flex-column">
                    <li class="nav-item mb-2">
                        <a class="nav-link" href="#">
                            <i class="p-2" ><svg width="25" height="26" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="action-column">
                            <button class="btn btn-primary btn-sm " style=" width :100px" >Xác nhận</button>
                            <button class="btn btn-danger btn-sm" style=" width :100px" >Hủy</button>
                        </td>
                    </tr>
                    <tr>
                        <td>8</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" style=" width :100px" data-bs-dismiss="modal">Hủy</button>
                <button type="button" class="btn btn-primary" style=" width :100px" id="confirmAppointmentButton">Xác nhận</button>
            </div>
        </div>
    </div>
</div>
