        ...
        <div class="col-md-10">
            ...
            <div class="p-4">
                ...
                <ul class="nav nav-tabs mb-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ route('employees.schedulecancel') }}">Đã
                            hủy
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#cancelModal" onclick="populateModal({{ $user->toJson() }})">
                                    Xem thông tin
                                </button>
                            </td>
                        </tr>
...
<script>
    function populateModal(user) {
        ...
        document.getElementById('reason').value = user.schedules_as_customer[0]?.message ?? 'N/A';
        document.getElementById('time').value = user.schedules_as_customer[0]?.date ?? 'N/A';
    }
</script>
